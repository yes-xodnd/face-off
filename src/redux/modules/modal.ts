...
const SHOW_ADD_FRIENDS = 'modal/SHOW_ADD_FRIENDS';
const HIDE_ADD_FRIENDS = 'modal/HIDE_ADD_FRIENDS';
const SHOW_ADMIN_FRIENDS = 'modal/SHOW_ADMIN_FRIENDS';
const HIDE_ADMIN_FRIENDS = 'modal/HIDE_ADMIN_FRIENDS';
