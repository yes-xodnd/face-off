...
import image0 from '../../../assets/img/capture/00시작하기.jpg';
import image1 from '../../../assets/img/capture/01옵션선택.jpg';
import image2 from '../../../assets/img/capture/02대상선택.jpg';
import image3 from '../../../assets/img/capture/03결과이미지.jpg';
import image4 from '../../../assets/img/capture/04로그인시얼굴등록.jpg';
import image5 from '../../../assets/img/capture/05얼굴등록.jpg';
import image6 from '../../../assets/img/capture/06모자이크대상제외.jpg';
import image7 from '../../../assets/img/capture/07아는얼굴수정.jpg';
import image8 from '../../../assets/img/capture/08커스텀스티커.jpg';



function WelcomeHowTo() {
  // const srcList = [
  ...
  const ExampleImg = ({ idx }) => (
    <div className="example-img-wrap1">
      <img className="example-img1" src={srcList[idx]} alt="example"/>
    </div>
  );
